...
public class FAQMain extends AppCompatActivity {
    ...
    private void addData() {
        ...
        FAQArrayList.add(new FAQ("Q : Bagaimana cara melakukan Donasi?", "Cari Komunitas yang membuka donasi, kemudian pilih kategori barang yang disumbangkan, lalu antar barang ke alamat komunitas tersebut"));
        FAQArrayList.add(new FAQ("Q : Bisakah Donasi di kirim lewat ekspedisi ke alamat komunitas?", "Saat ini Donasi hanya bisa dikirim dengan sistem drop off donasi atau Pick Up by Community"));
    }
}